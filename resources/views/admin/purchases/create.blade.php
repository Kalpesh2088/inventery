                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('products_id', [null => trans('admin.purchases.form.products_placeholder')] + $productes, '1', [
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('supplier_id', [null => trans('admin.purchases.form.supplier_placeholder')] + $supplier, '1', [
                                    'class' => 'form-control  select2',
                                ]) !!}
                                <span class="text-danger error-span pt-2" id="error_status"></span>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::number('purchased_quantity', '', [
                                        'class' => 'form-control',
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::number('supplier_invoice_number', '', [
                                        'class' => 'form-control',
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select('status', [null => trans('admin.purchases.form.status_placeholder')] + PURCHAS_STATUS, '1', [
                                        'class' => 'form-control  select2',
                                    ]) !!}
                                    <span class="text-danger error-span pt-2" id="error_status"></span>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-primary"
                                        onclick="submitPostForm('#CreateForm','{{ route('admin.purchases.store') }}')">Save</button>
