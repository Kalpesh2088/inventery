                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('brand_id', [null => trans('admin.products.form.brand_placeholder')] + $brands, '1', [
                                    'class' => 'form-control  select2',
                                ]) !!}
                                <span class="text-danger error-span pt-2" id="error_status"></span>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('discount_id', [null => trans('admin.products.form.discount_placeholder')] + $discounts, '1', [
                                    'class' => 'form-control  select2',
                                ]) !!}
                                <span class="text-danger error-span pt-2" id="error_status"></span>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('status', [null => trans('admin.products.form.status_placeholder')] + FOEM_STATUS, '1', [
                                    'class' => 'form-control  select2',
                                ]) !!}
                                <span class="text-danger error-span pt-2" id="error_status"></span>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="hstack gap-2 justify-content-end">
                                <button type="button" class="btn btn-primary"
                                    onclick="submitPostForm('#CreateForm','{{ route('admin.products.store') }}')">Save</button>
