                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select('category_id', [null => trans('admin.expenses.form.expenses_placeholder')] + $expense, $obj->category_id, [
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::text('reference', $obj->reference, [
                                        'class' => 'form-control',
                                        'id' => 'reference',
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::text('descriptiion', $obj->descriptiion, [
                                        'class' => 'form-control',
                                        'id' => 'descriptiion',
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select(
                                        'status',
                                        [null => trans('admin.expenses.form.status_placeholder')] + FOEM_STATUS,
                                        $obj->status,
                                        [
                                            'class' => 'form-control  select2',
                                        ],
                            ...
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-primary"
                                        onclick="submitPostForm('#CreateForm','{{ route('admin.expenses.update', $obj->id) }}')">Update</button>
