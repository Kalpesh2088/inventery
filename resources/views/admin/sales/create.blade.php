                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('products_id', [null => trans('admin.sales.form.products_placeholder')] + $productes, '1', [
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('customer_id', [null => trans('admin.sales.form.customer_placeholder')] + $customer, '1', [
                                    'class' => 'form-control  select2',
                                ]) !!}
                                <span class="text-danger error-span pt-2" id="error_status"></span>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('payment_id', [null => trans('admin.sales.form.payment_placeholder')] + $payment, '1', [
                                    'class' => 'form-control  select2',
                                ]) !!}
                                <span class="text-danger error-span pt-2" id="error_status"></span>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                {!! Form::select('delivery_id', [null => trans('admin.sales.form.delivery_placeholder')] + $delivery, '1', [
                                    'class' => 'form-control  select2',
                                ]) !!}
                                <span class="text-danger error-span pt-2" id="error_status"></span>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::date('expected_shipment_date', '', [
                                        'class' => 'form-control',
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select('status', [null => trans('admin.sales.form.status_placeholder')] + PURCHAS_STATUS, '1', [
                                        'class' => 'form-control  select2',
                                    ]) !!}
                                    <span class="text-danger error-span pt-2" id="error_status"></span>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-primary"
                                        onclick="submitPostForm('#CreateForm','{{ route('admin.sales.store') }}')">Save</button>
