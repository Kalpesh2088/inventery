                ...
                <div class="card-header border-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('admin.delivery_methods.create') }}" class="btn btn-danger">
                                <i class="ri-add-line align-bottom me-1"></i>{{ trans('admin.delivery_methods.create_button_text') }}
                            </a>
                        </div>
                    </div>
                </div>
