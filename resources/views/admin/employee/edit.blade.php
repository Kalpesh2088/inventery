                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select('role_id', [null => trans('admin.employee.form.role_placeholder')] + $role, $obj->role_id, [
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::text('password', $obj->password, [
                                        'class' => 'form-control',
                                        'type' => "password",
                                        'id' => 'password',
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::number('pincode', $obj->pincode, [
                                        'class' => 'form-control',
                                        'id' => 'pincode',
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select('status', [null => trans('admin.employee.form.status_placeholder')] + FOEM_STATUS, $obj->status, [
                                        'class' => 'form-control  select2',
                                    ]) !!}
                                    <span class="text-danger error-span pt-2" id="error_status"></span>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-primary"
                                        onclick="submitPostForm('#CreateForm','{{ route('admin.employee.update', $obj->id) }}')">Update</button>
                                    <a href="{{ route('admin.employee.index') }}" class="btn btn-soft-success">Cancel</a>
                                </div>
                            </div>
                            <!--end col-->
                        </div>
