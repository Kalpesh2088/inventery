                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    {!! Form::select('status', [null => trans('admin.warehouses.form.status_placeholder')] + FOEM_STATUS, $obj->status, [
                            ...
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-primary"
                                        onclick="submitPostForm('#CreateForm','{{ route('admin.warehouses.update', $obj->id) }}')">Update</button>
                                    <a href="{{ route('admin.warehouses.index') }}" class="btn btn-soft-success">Cancel</a>
                                </div>
                            </div>
                            <!--end col-->
                        </div>
