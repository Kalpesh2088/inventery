                ...
                <div class="card-body">
                    <form action="javascript:void(0);" id="CreateForm">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    {!! Form::label('name', trans('admin.expense_categories.form.name_label')) !!} <span class="text-danger">*</span>
                                    {!! Form::text('name', $obj->name, [
                                        'class' => 'form-control',
                                        'id' => 'name',
                                        'placeholder' => trans('admin.expense_categories.form.name_placeholder'),
                                        'required',
                                    ]) !!}
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    {!! Form::label('status', trans('admin.expense_categories.form.status_label')) !!}
                                    {!! Form::select(
                                        'status',
                                        [null => trans('admin.expense_categories.form.status_placeholder')] + FOEM_STATUS,
                                        $obj->status,
                                        [
                            ...
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-primary"
                                        onclick="submitPostForm('#CreateForm','{{ route('admin.expense_categories.update', $obj->id) }}')">Update</button>
...
@section('scripts')
    <script type="text/javascript">
        function submitPostForm(form_id, form_action_url) {
            callPostAjax(form_action_url, form_id, 0, 1, "{{ route('admin.expense_categories.index') }}");
        }
    </script>
@endsection
